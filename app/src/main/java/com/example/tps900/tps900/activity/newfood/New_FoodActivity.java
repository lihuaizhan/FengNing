...
import com.example.tps900.tps900.adapters.FoodMyAdapter;
import com.example.tps900.tps900.fragment.New_Fragment_pro_type_food;
...
public class New_FoodActivity extends BaseActivity {
    ...
    private FoodMyAdapter myAdapter;
    ...
    public void initData() {
            ...
            public void onClick(View view) {
                if (cardLayout.getVisibility() == View.GONE) {
                    ...
                    if (Constant.BEANS.size() > 0) {
                        ...
                        FoodMyAdapter myAdapter = new FoodMyAdapter(New_FoodActivity.this, Constant.BEANS, settlement, shoppingPrise, shoppingNum, defaultText);
        ...
        settlement.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                openActivity(NewFoodPayActivity.class, bundle, 1002);
            }
        });
    ...
    public void updateViews(ArrayList<DetailBean.DtBean> beans) {
        if (null == beans) {
            ...
            if (beans.size() == 0) {
                ...
                myAdapter = new FoodMyAdapter(New_FoodActivity.this, beans, settlement, shoppingPrise, shoppingNum, defaultText);
                shopproductListView.setAdapter(myAdapter);
    ...
    private class ShopAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int arg0) {
            Fragment fragment = new New_Fragment_pro_type_food();
            Bundle bundle = new Bundle();
