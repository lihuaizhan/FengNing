...
public class Pay_foodAdapter extends BaseAdapter {

    private ArrayList<PayBean.DtBean> list;
    private LayoutInflater mInflater;
    private int selectedIndex=-1;

    public Pay_foodAdapter(ArrayList<PayBean.DtBean> list, Context context) {
        this.list = list;
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ViewHolder holder;
        if (convertView == null) {
            convertView = mInflater.inflate(R.layout.item_pay_food, null);
...
//        }
        else if (-1 == payBean.getNPAYMENTTYPEX()) {
            //挂单
            holder.icon.setImageResource(R.drawable.apily_temple);
        } else {
