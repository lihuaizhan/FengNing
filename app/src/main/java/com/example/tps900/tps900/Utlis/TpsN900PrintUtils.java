...
import static com.example.tps900.tps900.Utlis.OtherUtils.mul;
...
public class TpsN900PrintUtils {
    /**
     * @author zxh
    ...
    public static void TpsN900OneCardPrint(Context context, ArrayList<DetailBean.DtBean> list, double money, String orderNo, String payType, String cardNo, double cardMoney) throws Exception {
        ...
        try {
            ...
            mUsbThermalPrinter.addString("付款金额:" + new DecimalFormat("#0.00").format(money));
     ...
     * 方法说明: 商品售卖中的一卡通打印小票清单
     */
    public static void TpsN900OneCardPrintVip(Context context, ArrayList<DetailBean.DtBean> list, double money, String orderNo, String payType, String cardNo, double cardMoney,String billNumber ) throws Exception {
        int totalCount = 0;
        for (int i = 0; i < list.size(); i++) {
            DetailBean.DtBean detailBean = list.get(i);
            totalCount += detailBean.getGoodsCount();
        ...
        try {
            ...
            mUsbThermalPrinter.addString("收银   员:  " + Constant.USERNAME);
            mUsbThermalPrinter.addString("订单编号:  " + orderNo);
            mUsbThermalPrinter.addString("会员订单号:  " + billNumber);
            mUsbThermalPrinter.addString("---------------------------");
            mUsbThermalPrinter.setAlgin(UsbThermalPrinter.ALGIN_LEFT);//设置居左
            mUsbThermalPrinter.addString("名称/" + "条码" + "   单价   数量   小计");
            LogUtil.i("TpsN900PrintUtils", "list的大小--->：" + list.size());
     ...
     * 方法说明: 商品售卖中的打印小票清单
     */
    public static void TpsN900PrintVip(Context context, ArrayList<DetailBean.DtBean> list, double money, String orderNo, String payType,String billNumber) throws Exception {
        int totalCount = 0;
        for (int i = 0; i < list.size(); i++) {
            DetailBean.DtBean detailBean = list.get(i);
            totalCount += detailBean.getGoodsCount();
    ...
    public static void TpsN900ReturnPrint(Context context, ArrayList<ReturnBean> list, String money, String orderNo, String newOrder, String payType) throws Exception {
        ...
        try {
            ...
            mUsbThermalPrinter.addString("支付类型:" + payType);
            mUsbThermalPrinter.addString("退款金额:" + money);
            mUsbThermalPrinter.addString("---------------------------");
            mUsbThermalPrinter.printString();
    ...
    public static void TpsN900OneCardPrint_Food_2Vip(Context context, ArrayList<DetailBean.DtBean> list, double money, String orderNo, String payType, String cardNo, double cardMoney, String tableNo, String tablePeople,String bill) throws Exception {
        int totalCount = 0;
        for (int i = 0; i < list.size(); i++) {
            DetailBean.DtBean detailBean = list.get(i);
            totalCount += detailBean.getGoodsCount();
        ...
        try {
            ...
            mUsbThermalPrinter.addString("收银   员:  " + Constant.USERNAME);
            mUsbThermalPrinter.addString("订单编号:  " + orderNo);
            mUsbThermalPrinter.addString("会员订单号:  " + bill);
//            mUsbThermalPrinter.addString("桌台   号:  " + tableNo);
//            mUsbThermalPrinter.addString("桌台人数:  " + tablePeople);
            mUsbThermalPrinter.addString("---------------------------");
            mUsbThermalPrinter.setAlgin(UsbThermalPrinter.ALGIN_LEFT);//设置居左
            mUsbThermalPrinter.addString("名称/" + "条码" + "   单价   数量   小计");
            for (int i = 0; i < list.size(); i++) {
...
//            mUsbThermalPrinter.addString("桌台人数:  " + tablePeople);
    ...
    public static void TpsN900Print_Food_2Vip(Context context, ArrayList<DetailBean.DtBean> list, double money, String orderNo, String payType, String tableNo, String tablePeople,String bill) throws Exception {
        int totalCount = 0;
        for (int i = 0; i < list.size(); i++) {
            DetailBean.DtBean detailBean = list.get(i);
            totalCount += detailBean.getGoodsCount();
