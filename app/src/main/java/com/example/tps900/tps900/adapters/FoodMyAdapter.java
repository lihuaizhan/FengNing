...
public class FoodMyAdapter extends BaseAdapter {
    ...
    public FoodMyAdapter(Context context, ArrayList<DetailBean.DtBean> beans, TextView settlement, TextView shoppingPrise, TextView shoppingNum, TextView defaultText) {
