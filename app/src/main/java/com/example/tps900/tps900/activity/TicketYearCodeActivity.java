...
public class TicketYearCodeActivity extends BaseActivity {
    //扫描
    ...
    Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                //扫描
                case Scanning:
                    Intent intent = new Intent(TicketYearCodeActivity.this, CaptureActivity.class);
                ...
                case Failed:
                    ...
                    ErrDialog2(TicketYearCodeActivity.this, msgInfo, "");
                    timerTask();
                    break;
                case Emptied://清除数据
                    ticketName.setText("");
    ...
    public void initView() {
        ...
        progressDialog = new ProgressDialog(TicketYearCodeActivity.this);
    ...
    public void initData() {
        ...
        practicalPersonNum.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                ...
                new KeyboardUtil(getApplicationContext(), TicketYearCodeActivity.this, practicalPersonNum, R.id.schemas_key_keyboard_view).showKeyboard();
            }
        });
        ticketEtTicketCode.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                ...
                new KeyboardUtil(getApplicationContext(), TicketYearCodeActivity.this, ticketEtTicketCode, R.id.schemas_key_keyboard_view).showKeyboard();
    ...
    public void onClick(View view) {
        ...
        if (id == R.id.ticket_et_ticketCode) {
            ...
            TicketYearCodeActivity.this.startActivity(new Intent(this, MainActivity.class));
            finish();
            ...
            if (getTicketCode.MEMBER_PHOTO == null) {
                ...
                Intent intent = new Intent(TicketYearCodeActivity.this, ImgShowActivity.class);
                intent.putExtra("bitmap", buff);
                TicketYearCodeActivity.this.startActivity(intent);
            }
        }
    }
                    ...
                    if (getUpadateTicketBean.FLAG) {
                        ThreadPoolUtils.runTaskInUIThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                TpsN900PrintUtils.TpsN900Print_ticket(TicketYearCodeActivity.this,"门票核销",
    ...
    protected void onActivityResult(int requestCode, int resultCode, final Intent data) {
        if (data != null) {
            ...
            Toast.makeText(TicketYearCodeActivity.this, "扫描结果为空", Toast.LENGTH_LONG).show();
        }
    }
    ...
    public void btn_comit() {
        TicketYearCodeActivity.this.runOnUiThread(new Runnable() {
            @Override
            public void run() {
                if (TextUtils.isEmpty(ticketState.getText().toString().trim())) {
                    ToastUtils.show(TicketYearCodeActivity.this, "请先扫描门票");
                    return;
                    ...
                    if (TextUtils.isEmpty(ticketNum)) {
                        ToastUtils.show(TicketYearCodeActivity.this, "请输入入园次数");
                    } else if (Integer.valueOf(ticketNum) > Integer.valueOf(inParkTime) || Integer.valueOf(ticketNum) < Integer.valueOf(inParkTime)) {
                        ToastUtils.show(TicketYearCodeActivity.this, "请输入正确入园次数");
                    } else {
                        ...
                        } else if (barcode.length() < 24 && barcode.length() >=12) {
                            runOnUiThread(new Runnable() {
                                @Override
                                public void run() {
                                    HttpUtils.showProgressDialog(progressDialog);
    ...
    public void btn_QueryticketInfo(final String barcode) {
        ...
        if (!TextUtils.isEmpty(barcode)) {
            ...
            } else if (barcode.length() < 24 && barcode.length() >= 12) {//小于24位的就是线上票
                HttpUtils.showProgressDialog(progressDialog);
                ThreadPoolUtils.runTaskInThread(new Runnable() {
                    @Override
                    public void run() {
