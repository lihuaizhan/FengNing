...
public class SltPeopleActivity extends Activity {
    ...
    public void initData() {
        ...
        sltAdapter = new SltPeopleAdapter(R.layout.slt_people_item, data, SltPeopleActivity.this, isClicks);
        //显示布局风格
        ...
        selectPeopleBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (null == item) {//0==item.getPeopleNum()
                    ToastUtils.show(SltPeopleActivity.this, "请选择人数");
                } else {
                    Log.e("SltTableActivity", item.getPeopleNum() + "");
                    Constant.TablePeople = String.valueOf(item.getPeopleNum());
                    Intent intent = new Intent(SltPeopleActivity.this, Pay_foodActivity.class);
                    intent.putExtra("tableMoney", tablemoney);
